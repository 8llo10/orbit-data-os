...
export type Evidence={kind:'metric'|'collection'|'field'|'sample'|'warning';label:string;value:string;collectionId?:string};
...
export type AssistantResult={answer:string;intent:AssistantIntent;confidence:number;evidence:Evidence[];actions:AssistantAction[];followUps:string[];mode:'deterministic'|'ai-orchestrated';requestId:string};
